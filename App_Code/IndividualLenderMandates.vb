...
Public Class IndividualLenderMandates
    Public Shared _LenderMandateDateCreated As String
    Public Shared _LenderMandateTenorMax As String
    Public Shared _LenderMandateMin_InterestRate As String
    Public Shared _LenderMandatMax_LTV As String
    Public Shared _LenderMandateTenorMin As String
    Public Shared _LenderMandateMax_LGDV As String
    Public Shared _LenderMandateA_Percent_Of_Drawdown As String
    Public Shared _LenderMandateA_Max_Amount As String
    Public Shared _LenderMandateB_Amount As String
    Public Shared _LenderMandateConcentration As String
    Public Shared _LenderMandateComplate As String
    Public Shared _LenderMandateLegacy_Settings As String
    Public Shared _LenderMandateDiversification As String
    Public Shared _LenderMandateMandate_Group As String
    ...
    Public Shared Function GetIndividualMandateDetails(ByVal AccountID As String, ByVal UserID As String)
